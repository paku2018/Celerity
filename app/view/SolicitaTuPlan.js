    ...
    <View style={styles.container}>
        <ImageBackground source={require('../assets/img/pagos/background_.png')} style={styles.image}>
            ...
            <View style={styles.content}>
                <LinkButton url={require('../assets/img/solicita/btn_1.png')} styles={{marginTop: height(1)}} />
                <LinkButton url={require('../assets/img/solicita/btn_2.png')} styles={{marginTop: height(1)}} />
                <LinkButton url={require('../assets/img/solicita/btn_3.png')} styles={{marginTop: height(1)}} />
            </View>
            <Footer/>
        </ImageBackground>
    </View>
